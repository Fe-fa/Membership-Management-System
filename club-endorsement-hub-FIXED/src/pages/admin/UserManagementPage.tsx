...
export function UserManagementPage() {
  ...
  const list = useQuery({
    queryKey: ["managed-users", search, status, role, page],
    queryFn: () => {
  ...
  return (
    <PageFrame width="lg">
      ...
      <PageHeader
        ...
        description="Admin creates staff, receptionists and members. They verify by email and set a password. Applicants register on the website."
        actions={
    ...
    <Dialog open={open} onOpenChange={(next) => (next ? onOpenChange(true) : close())}>
      <DialogContent className="max-w-lg">
        <DialogHeader>
          ...
          <DialogDescription>
            Creates a staff, receptionist or member account. They receive a link to choose a
            password. Roles other than Super Admin require a membership number (linked to the club
            register). Applicants must use the public registration page.
          </DialogDescription>
        </DialogHeader>
        ...
        {invite ? (
          ...
          >
            ...
            {needsMembershipNo ? (
              ...
              <p className="text-xs text-muted-foreground">
                Admin-only accounts do not need a membership number.
              </p>
            )}
