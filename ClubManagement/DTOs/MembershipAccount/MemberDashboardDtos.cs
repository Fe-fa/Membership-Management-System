...
public class MemberSubscriptionDto
{
    ...
    /// <summary>Unpaid annual from earlier years, included in Outstanding.</summary>
    ...
    public string StatusCode { get; set; } = string.Empty;
    /// <summary>True when the membership account is on the active register.</summary>
    ...
    /// <summary>Paid | PartiallyPaid | PendingVerification | Unpaid | NotBilled</summary>
    public string AnnualPaymentStatus { get; set; } = "Unpaid";
    /// <summary>Paid | PartiallyPaid | PendingVerification | Unpaid | Waived | NotBilled</summary>
    public string JoiningPaymentStatus { get; set; } = "Unpaid";

    /// <summary>Open billed charges from Finance (accommodation, corkage, custom). Hidden until invoiced.</summary>
    public List<MemberOpenChargeDto> OpenCharges { get; set; } = new();
}

public class MemberOpenChargeDto
{
