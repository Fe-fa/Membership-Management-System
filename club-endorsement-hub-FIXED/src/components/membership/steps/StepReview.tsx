    ...
    return [
      {
        ...
        rows: [
          ...
          {
            label: "Occupation",
            value: `${dash(p.occupation)} Â· ${dash(p.company)} Â· ${dash(p.role)}`,
          },
          { label: "Blood group / gender", value: `${dash(p.bloodGroup)} Â· ${dash(p.gender)}` },
      ...
      },
      {
        ...
        rows: [
          ...
          { label: "Emergency contact", value: dash(f.emergencyName) },
          {
            ...
            value: `${dash(f.emergencyPhone)} Â· ${dash(f.emergencyEmail)}`,
          },
        ],
      },
      {
        ...
        rows: [
          ...
          ...(a.holdsLicense
            ? [
                {
                  label: "Licence",
                  value: `${dash(a.licenseType)} Â· ${dash(a.licenseNumber)} Â· ${dash(a.licenseIssuer)}`,
                },
          ...
          ...(a.ownsAircraft
            ? [
                {
                  label: "Aircraft",
                  value: `${dash(a.aircraftType)} Â· ${dash(a.aircraftRegistration)}`,
                },
        ...
        rows: omitSupporters
          ...
          : [
              { label: "Membership type", value: dash(m.membershipType) },
              {
                ...
                value: `${dash(m.applicantSignature)} Â· ${formatKenyaDate(m.signatureDate)}`,
              },
            ],
      },
      ...(omitSupporters
