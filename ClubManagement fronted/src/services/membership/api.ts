  ...
  await apiRequest(`/api/applications/${applicationId}/details`, {
    ...
    body: JSON.stringify({
      ...
      family: {
        ...
        emergencyName: draft.family.emergencyContacts?.[0]?.name || null,
        emergencyPhone: draft.family.emergencyContacts?.[0]?.phone || null,
        emergencyEmail: draft.family.emergencyContacts?.[0]?.email || null,
        nextOfKinName: draft.personal.nextOfKinName || null,
        nextOfKinRelationship: draft.personal.nextOfKinRelationship || null,
        nextOfKinPhone: draft.personal.nextOfKinPhone || null,
        nextOfKinEmail: draft.personal.nextOfKinEmail || null,
      },
      aviation: {
