    ...
    >
      <div className="flex flex-col gap-4 p-5 sm:flex-row sm:items-start sm:justify-between">
        ...
        <div className="flex flex-col items-start gap-2 sm:items-end">
          ...
          {app.statusCode === "Rejected" && app.lastRejectionReason ? (
            <p className="max-w-xs text-xs text-rose-800 sm:text-right">{app.lastRejectionReason}</p>
          ) : null}
        </div>
      </div>
      ...
      <div className="flex flex-wrap items-center gap-0.5 border-t border-border px-5 py-3">
        ...
        <Button asChild size="icon" variant="ghost" className="size-8" title="Update application">
